...
//             children: [
//               Image.network(
//                 'https://maps.googleapis.com/maps/api/staticmap?center=${widget.spot.location.latitude},${widget.spot.location.longitude}&zoom=15&size=600x300&maptype=roadmap&markers=color:red%7C${widget.spot.location.latitude},${widget.spot.location.longitude}&key=AIzaSyAMtI0X-3jyLGu0qO3UOb4UmymnZ50yJ68',
//                 fit: BoxFit.cover,
//                 height: 150.0,
...
//               ),
//               SizedBox(height: 8),
//               Text('Address: ${widget.spot.vicinity}'),
...
//                             ),
//                             locationAddress: widget.spot.vicinity,
//                           ),
//                         ),
//                       );
//                     } else {
